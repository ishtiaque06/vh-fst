            ...
            9:
                {
                    ...
                    'transitions': {(0,'?'):('?',0),(1,'?'):('?',1),(2,'?'):('?',2),(3,'?'):('?',3),(4,'?'):('?',4),
                                   (0,'+'):('+',0),(0,'a'):('a',0),(0,'-'):('-',4),(0,'u'):('u',1),(0,'i'):('i',1),
                                   (1,'+'):('+',1),(1,'a'):('a',1),(1,'u'):('u',1),(1,'i'):('i',1),(1,'-'):('-',2),
                                   (2,'a'):('i',2),(2,'-'):('-',2),(2,'i'):('i',3),(2,'u'):('u',3),(2,'+'):('+',3),
                                   (3,'+'):('+',3),(3,'a'):('a',3),(3,'u'):('u',3),(3,'i'):('i',3),(3,'-'):('-',3),
                                   (4,'+'):('+',4),(4,'a'):('a',4),(4,'u'):('u',4),(4,'i'):('i',4),(4,'-'):('-',4),
                                   },
                    'preprocess_req': True,
            ...
            26:
                {
                    ...
                    'transitions': {(0,'?'):('?',1),(1,'?'):('?',1),(2,'?'):('?',2),
                                   (3,'?'):('?',3),(0,"'"):("'",0),(1,"'"):("'",1),
                                   (2,"'"):("'",3),(3,"'"):("'",3),(0,'a'):('a',1),
                                   (0,'o'):('o',1),(0,'e'):('e',1),}(0,Cent_C_L_U_NT):(Cent_C_L_U_NT,1),(0,Cent_B_M_R_T):(Cent_B_M_R_T,1),
                                   (0,'u'):(Cent_B_H_R_T,2),(0,Cent_B_H_R_T):(Cent_B_H_R_T,2),(0,Cent_F_H_U_T):(Cent_F_H_U_T,2),
                                   (0,'i'):('i',2),(1,'a'):('a',1),(1,'o'):('o',1),(1,'e'):('e',1),(1,Cent_C_L_U_NT):(Cent_C_L_U_N_T,1),
                                   (1,Cent_B_M_R_T):(Cent_B_M_R_T,1),(1,'u'):('u',2),(1,'i'):('i',2),(1,Cent_F_H_U_T):(Cent_F_H_U_T,2),
                                   (1,Cent_B_H_R_T):(Cent_B_H_R_T,2),(2,'i'):('i',2),(2,'u'):('u',2),(2,Cent_F_H_U_T):(Cent_F_H_U_T,2),
                                   (2,Cent_B_H_R_T):(Cent_B_H_R_T,2),(2,'a'):('a',1),(2,'o'):('o',1),(2,'e'):('e',1),
                                   (2,Cent_C_L_U_NT):(Cent_C_L_U_N_T,1),(2,Cent_B_M_R_T):(Cent_B_M_R_T,1),(3,'i'):('i',2),
                                   (3,'u'):('u',2),(3,Cent_F_H_U_T):(Cent_F_H_U_T,2),(3,Cent_B_H_R_T):(Cent_B_H_R_T,2),
                                   (3,'e'):('i',1),(3,'o'):('u',1),(3,'a'):('a',1),(3,Cent_C_L_U_NT):(Cent_C_L_U_NT,1),
             ...
             '26B':
                {
                    ...
                    'transitions': {(0,'?'):('?',0),(1,'?'):('?',0),(2,'?'):('?',3),
                                   (3,'?'):('?',3),(4,'?'):('?',0),(5,'?'):('?',0),(6,'?'):('?',2),
                                   (0,"'"):("'",1),(1,"'"):("'",1),
                                   (3,"'"):("'",4),(2,"'"):("'",2),(4,"'"):("'",4),(5,"'"):("'",5),(6,"'"):("'",6),
                                   (0,'j'):('j',0),(0,'w'):('w',0),(0,'a'):('a',0),(0,Cent_C_L_U_NT):(Cent_C_L_U_NT,0),
                                   (0,'e'):('e',0),(0,'o'):('o',0),(0,Cent_B_M_R_T):(Cent_B_M_R_T,0),
                                   (0,'i'):('i',0),(0,Cent_F_H_U_T):(Cent_F_H_U_T,0),(0,'u'):('u',0),(0,Cent_B_H_R_T):(Cent_B_H_R_T,0),
                                   (1,'e'):('e',1),(1,'o'):('o',1),(1,Cent_B_M_R_T):(Cent_B_M_R_T,1),(1,'a'):('a',1),
                                   (1,Cent_C_L_U_NT):(Cent_C_L_U_NT,1),(1,'i'):('i',2),(1,'u'):('u',2),(1,'j'):('j',2),(1,'w'):('w',2),
                                   (1,Cent_F_H_U_T):(Cent_F_H_U_T,2),(1,Cent_B_H_R_T):(Cent_B_H_R_T,2),
                                   (2,'a'):('a',2),(2,Cent_C_L_U_NT):(Cent_C_L_U_NT,2),
                                   (2,'e'):('e',2),(2,'o'):('o',2),(2,Cent_B_M_R_T):(Cent_B_M_R_T,2),(2,'i'):('i',2),
                                   (2,Cent_F_H_U_T):(Cent_F_H_U_T,2),(2,'u'):('u',2),(2,Cent_B_H_R_T):(Cent_B_H_R_T,2),
                                   (2,'j'):('j',3),(2,'w'):('w',3),(3,'j'):('j',3),(3,'w'):('w',3),(3,'e'):('i',5),
                                   (3,'a'):('a',5),(3,Cent_C_L_U_NT):(Cent_C_L_U_NT,5),(3,'u'):('u',5),(3,Cent_B_H_R_T):(Cent_B_H_R_T,5),
                                   (3,'i'):('i',5),(3,Cent_F_H_U_T):(Cent_F_H_U_T,5),(3,'o'):('u',5),(3,Cent_B_M_R_T):(Cent_B_H_R_T,5),
                                   (4,'j'):('j',2),(4,'w'):('w',2),(4,'a'):('a',4),(4,Cent_C_L_U_NT):(Cent_C_L_U_NT,4),
                                   (4,'o'):('u',4),(4,'e'):('i',4),(4,Cent_B_M_R_T):(Cent_B_H_R_T,4),(4,'i'):('i',6),
                                   (4,Cent_F_H_U_T):(Cent_F_H_U_T,6),(4,'u'):('u',6),(4,Cent_B_H_R_T):(Cent_B_H_R_T,6),
                                   (5,'j'):('j',0),(5,'w'):('w',0),(5,'i'):('i',5),(5,'u'):('u',5),(5,'a'):('a',5),
                                   (5,Cent_F_H_U_T):(Cent_F_H_U_T,5),(5,Cent_B_H_R_T):(Cent_B_H_R_T,5),(5,Cent_C_L_U_NT):(Cent_C_L_U_NT,5),
                                   (5,'o'):('u',5),(5,'e'):('i',5),(5,Cent_B_M_R_T):(Cent_B_H_R_T,5),
                                   (6,'j'):('j',2),(6,'w'):('w',2),(6,'a'):('a',6),(6,Cent_C_L_U_NT):(Cent_C_L_U_NT,6),
                                   (6,'o'):('u',6),(6,'e'):('i',6),(6,Cent_B_M_R_T):(Cent_B_H_R_T,6),
                                   (6,'i'):('i',6),(6,Cent_F_H_U_T):(Cent_F_H_U_T,6),(6,'u'):('u',6),(6,Cent_B_H_R_T):(Cent_B_H_R_T,6)}, #(5,''):('',5) should never occur, but I included it; if it does occur, the result will be inaccurate
                    'preprocess_req': True,
                    'postprocess_req': True,
                    'left_subseq': False,
                    'bidir_subseq':False,
            ...
            27:
                {
                    ...
                    'notes': ['Regressive ATR (pharyngeal) harmony','/i,u,e,o/ are phonemes with a [+ATR] specification; /a,front-mid-unrounded-lax vowel,back-mid-rounded-lax vowel/ are [-ATR] phonemes','/i,u,a/ are blockers that trigger harmony for their own [ATR] specification'],
                    'harmony_feature':['ATR/RTR'],
                    'sc':False,
                    'dr':False,
                    'transparent':[],
            ...
            '28B':
                {
                    ...
                    'transitions': {(0,'?'):('?',0),(1,'?'):('?',1),(2,'?'):('?',2),(3,'?'):('?',3),(4,'?'):('?',4),
                                    ...
                                    (0,'i'):('i',1),(0,'u'):('u',1),(0,'e'):('e',1),(0,'o'):('o',1),(0,B_L_U_NT):(B_L_U_NT,2),
                                    (1,'i'):('i',1),(1,'u'):('u',1),(1,'e'):('e',1),(1,'o'):('o',1),(1,B_L_U_NT):(B_L_U_NT,2),
                                    (1,'I'):('i',1),(1,B_H_R_NT):('u',1),(1,F_M_U_NT):('e',1),(1,B_M_R_NT):('o',1),
                                    (2,'i'):('i',1),(2,'u'):('u',1),(2,'e'):('e',1),(2,'o'):('o',1),(2,B_L_U_NT):(B_L_U_NT,2),
                                    (2,'I'):('I',2),(2,B_H_R_NT)(B_H_R_NT,2),(2,F_M_U_NT):(F_M_U_NT,2),(2,B_M_R_NT):(B_M_R_NT,2),
                                    (3,'i'):('i',4),(3,'u'):('u',4),(3,'e'):('e',4),(3,'o'):('o',4),(3,B_L_U_NT):(B_L_U_NT,5),
                                    (3,'I'):('I',5),(3,B_H_R_NT)(B_H_R_NT,5),(3,F_M_U_NT):(F_M_U_NT,5),(3,B_M_R_NT):(B_M_R_NT,5),
                                    (4,'i'):('i',4),(4,'u'):('u',4),(4,'e'):('e',4),(4,'o'):('o',4),(4,B_L_U_NT):(B_L_U_NT,5),
                                    (4,'I'):('I',5),(4,B_H_R_NT)(B_H_R_NT,5),(4,F_M_U_NT):(F_M_U_NT,5),(4,B_M_R_NT):(B_M_R_NT,5),
                                    (5,'i'):('i',4),(5,'u'):('u',4),(5,'e'):('e',4),(5,'o'):('o',4),(5,B_L_U_NT):(B_L_U_NT,5),
                                    (5,'I'):('I',5),(5,B_H_R_NT)(B_H_R_NT,5),(5,F_M_U_NT):(F_M_U_NT,5),(5,B_M_R_NT):(B_M_R_NT,5),
                                    (6,'i'):('i',6),(6,'u'):('u',6),(6,'e'):('e',6),(6,'o'):('o',6),(6,B_L_U_NT):(B_L_U_NT,7),
                                    (6,'I'):('i',6),(6,B_H_R_NT):('u',6),(6,F_M_U_NT):('e',6),(6,B_M_R_NT):('o',6),
                                    (7,'i'):('i',6),(7,'u'):('u',6),(7,'e'):('e',6),(7,'o'):('o',6),(7,B_L_U_NT):(B_L_U_NT,7),
                                    (7,'I'):('I',7),(7,B_H_R_NT)(B_H_R_NT,7),(7,F_M_U_NT):(F_M_U_NT,7),(7,B_M_R_NT):(B_M_R_NT,7),
                                    (8,'i'):('i',8),(8,'u'):('u',8),(8,'e'):('e',8),(8,'o'):('o',8),(8,B_L_U_NT):(B_L_U_NT,7),
                                    (8,'I'):('i',8),(8,B_H_R_NT):('u',8),(8,F_M_U_NT):('e',8),(8,B_M_R_NT):('o',8),
                                   },#Many transitions that should be impossible were included for the sake of having a transition for each alphabet symbol from each state
                    'preprocess_req': True,
                    'postprocess_req': True,
                    'left_subseq': False,
                    'bidir_subseq':True,
            ...
            29:
                {
                    ...
                    'transitions': {(0,'?'):('?',0),(1,'?'):('?',0),(2,'?'):('?',0),(3,'?'):('?',0),
                                    ...
                                    (0,G_P_VL):(G_P_VL,0),(1,G_P_VL):(G_P_VL,6),(2,G_P_VL):(G_P_VL,7),(3,G_P_VL):(G_P_VL,8),
                                    (4,G_P_VL):(G_P_VL,9),(5,G_P_VL):(G_P_VL,10),(6,G_P_VL):(G_P_VL,0),(7,G_P_VL):(G_P_VL,0),
                                   ...
                                   }, #VV sequence is prohibited in syllable structure, but I included transtions to account for such anyways (I assume that the second vowel does harmonize in such a sequence; it is not possible to conclude if it would or not because such data isn't available
                    'preprocess_req': True,
                    'postprocess_req': False,
                    'left_subseq': True,
                    'bidir_subseq':False,
            ...
            '29P':
                {
                    ...
                    'transitions': {(0,'?'):('?',0),(1,'?'):('?',0),(2,'?'):('?',0),(3,'?'):('?',0),(4,'?'):('?',0),
                                    (0,'-'):('-',0),(1,'-'):('-',0),(2,'-'):('-',3),(3,'-'):('-',3),(4,'-'):('-',0),
             ...
             30:
                {
                    ...
                    'bidir_subseq':False,
                    'hyphenate_suffix': True, #instruct user to hyphenate suffix if there is in fact a suffix in the input
                    'preprocess_dets':"Add '!' at the beginning of the root/stem (ex: pre+pre+root-suf-suf -> pre+pre+!root-suf-suf); then enter into FST",
                    'postprocess_dets':None,
                    'notes': ['Std Hungarian also has labial vowel harmony, but it is not represented in this FST',
                             ...
                             'If the closest vowel to the left of an alternating suffix is a neutral vowel, it varies what palatal quality the suffix vowels will demonstrate:'
                              'If the last non-neutral vowel was a front vowel, then the suffix will have front vowels; if the root has only neutral vowels,'
                              'then the suffix will have front vowels; if the last non-neutral vowel is back, the quality of the vowels in the suffix depend'
                              'on the number of neutrals between that back vowel and the suffix--such that more neutrals increase probability of front-harmony--'
                              ',the height of the intervening neutral vowels--such that higher neutral vowels increase the likelihood of front-harmony--'
            ...
            '31B':
                {
                    ...
                    'plus_prefix':True,
                    'hyphenate_suffix':True,
                    'preprocess_dets':'Should have been processed and run through 31 accordingly; Reverse the output from 31 and enter into this FST',
                    'postprocess_dets':'Reverse output, this is the final output to user',
                    'notes': [],
                    'harmony_feature':['ATR/RTR'],
                    'sc':True,
