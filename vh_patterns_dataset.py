            ...
            29:
                {
                    ...
                    'transitions': {(0,'?'):('?',0),(1,'?'):('?',0),(2,'?'):('?',0),(3,'?'):('?',0),
                                   ...
                                   }, #VV sequence is prohibited in syllable structure, but I included transtions to account for such anyways (I assume that the second vowel does not harmonize in such a sequence; it is not possible to conclude if it would or not because such data isn't available
                    'preprocess_req': True,
                    'postprocess_req': False,
                    'left_subseq': True,
                    'bidir_subseq':False,
